...
class onLineShopTester(unittest.TestCase):
    ...
    #base_url = "https://afternoon-everglades-59043.herokuapp.com/"
    admin_url    = base_url + "admin/"
    shoppingcart_url = base_url + "cart/list/"
    ...
    catList     = ["Refrigerators", "Washing machines", "Dishwashers"]
    productDict = {catList[0]: ["refrigerator-1",
                 "refrigerator-2",
                 "refrigerator-3",
                 "refrigerator-4",
                 "refrigerator-5",
                 "refrigerator-6"],
                   catList[1]: ["washing-machine-1",
                 "washing-machine-2",
                 "washing-machine-3",
                 "washing-machine-4",
                 "washing-machine-5",
                 "washing-machine-6"],
                  catList[2]: ["dishwasher-1",
                 "dishwasher-2",
                 "dishwasher-3",
                 "dishwasher-4",
                 "dishwasher-5",
